...
import com.example.ecommercemissgirl.activity.usuario.DetalhesProdutoActivity;
...
import com.example.ecommercemissgirl.databinding.FragmentUsuarioHomeBinding;
...
public class UsuarioHomeFragment extends Fragment implements CategoriaAdapter.OnClick, LojaProdutoAdapter.OnClickLister, LojaProdutoAdapter.OnClickFavorito {
    ...
    private void configSearchView() {
        ...
        binding.searchView.findViewById(R.id.search_close_btn).setOnClickListener(v -> {
            EditText edtSearchView = binding.searchView.findViewById(R.id.search_src_text);
